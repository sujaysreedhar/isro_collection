...
<div class="mb-6 flex justify-between items-end">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-1">A geographic visualization of your collection. Click a marker to toggle acquired status.</p>
    </div>
    <div class="flex gap-3 text-xs font-semibold">
        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-50 text-green-700 rounded-full border border-green-200">
            <span class="w-2.5 h-2.5 bg-green-500 rounded-full"></span> Collected
        </span>
        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gray-50 text-gray-500 rounded-full border border-gray-200">
