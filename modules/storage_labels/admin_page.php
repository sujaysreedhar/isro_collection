...
<div class="p-4 lg:p-8 min-h-screen bg-gray-50/30">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 px-2">
        <div>
            <h1 class="text-4xl font-black text-gray-900 tracking-tight flex items-center gap-3">
                QR Label Generator
                <span
                    class="bg-blue-600 text-white text-[10px] px-2 py-1 rounded font-bold uppercase tracking-widest align-middle shadow-sm">Pro</span>
            </h1>
            <p class="text-gray-500 mt-2 font-medium">Configure dimensions, toggle metadata, and generate physical
                labels.</p>
        </div>
        <div class="flex items-center gap-3">
            <button onclick="window.print()"
                class="group bg-gray-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-black transition-all shadow-xl hover:shadow-2xl active:scale-95 flex items-center gap-3">
                <svg class="w-5 h-5 group-hover:animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
                        d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 00-2 2h2m2 4h10a2 2 0 002-2v-4H7v4a2 2 0 002 2zM9 17V5a2 2 0 012-2h2a2 2 0 012 2v12H9z" />
                </svg>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div class="lg:col-span-3 space-y-8">
            ...
            <div class="bg-white rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden p-6">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select id="config-page-size"
                            class="w-full px-4 py-3 bg-gray-50 border border-transparent rounded-xl text-sm font-semibold focus:bg-white focus:border-blue-500 transition-all outline-none">
                ...
                <div class="space-y-4">
                    <label class="flex items-center gap-4 cursor-pointer group">
                        <div class="relative">
                            ...
                            <div class="w-11 h-6 bg-gray-200 rounded-full peer-checked:bg-blue-600 transition-colors">
                            </div>
                            <div
                                class="absolute left-1 top-1 w-4 h-4 bg-white rounded-full transition-transform peer-checked:translate-x-5">
                            </div>
                        </div>
                        <span class="text-sm font-bold text-gray-700 group-hover:text-black transition">Reg
                            Number</span>
                    </label>
                    <label class="flex items-center gap-4 cursor-pointer group">
                        <div class="relative">
                        ...
                        <span class="text-sm font-bold text-gray-700 group-hover:text-black transition">Item
                            Title</span>
                    </label>
                    <label class="flex items-center gap-4 cursor-pointer group">
                        <div class="relative">
                        ...
                        <span class="text-sm font-bold text-gray-700 group-hover:text-black transition">Location
                            Info</span>
                    </label>
                </div>
            </div>
            ...
            <!-- Item Selection -->
            <div
                class="bg-white rounded-[2rem] border border-gray-200 shadow-sm overflow-hidden flex flex-col h-[500px]">
                <div class="p-6 bg-gray-50/50 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <button id="select-all-btn"
                        class="text-[10px] font-black uppercase tracking-widest text-blue-600 hover:text-blue-800 transition">Select
                        All</button>
                ...
                <div class="overflow-y-auto flex-1 p-4 space-y-1" id="item-selector">
                    <?php foreach ($items as $item): ?>
                        <label class="flex items-start p-4 rounded-2xl hover:bg-gray-50 transition cursor-pointer group">
                            <input type="checkbox"
                                class="item-checkbox w-5 h-5 mt-0.5 rounded-lg border-gray-300 text-blue-600 focus:ring-blue-500 transition-all"
                                data-id="<?= $item['id'] ?>" data-reg="<?= htmlspecialchars($item['reg_number']) ?>"
                            ...
                            <div class="ml-4 flex-1">
                                <span
                                    class="block text-sm font-black text-gray-900 group-hover:text-blue-600 transition tracking-tight">
            ...
            <div class="relative bg-white p-6 md:p-12 rounded-[3rem] border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    ...
                    <div class="flex items-center gap-6 mb-10 w-full max-w-[210mm]">
                        ...
                        <div class="flex items-center gap-3">
                            <span
                                class="px-4 py-1.5 bg-gray-900 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg"
                                id="preview-page-label">A4 CANVAS</span>
                            <span
                                class="px-4 py-1.5 bg-blue-50 text-blue-700 rounded-full text-[10px] font-black uppercase tracking-widest border border-blue-100"
                                id="preview-count-label">0 Labels</span>
                        </div>
                        <div class="bg-blue-600 h-1 flex-1 rounded-full opacity-20"></div>
                    </div>
                    ...
                    <!-- Virtual Sheet -->
                    <div
                        class="bg-gray-200 p-1 md:p-8 rounded-[2rem] shadow-inner w-full flex justify-center overflow-x-auto">
                        <div id="print-area-wrapper"
                            class="bg-white shadow-2xl transition-all duration-700 ease-in-out origin-top border border-white"
                            style="width: 210mm; min-height: 297mm;">
                            <div id="print-area" class="grid grid-cols-2 gap-4 p-[15mm]">
                                <!-- Labels injected via JS -->
                                <div id="empty-state"
                                    class="col-span-full flex flex-col items-center justify-center py-48 text-gray-300">
                                    <div
                                        class="w-32 h-32 mb-8 bg-gray-50 rounded-[2.5rem] flex items-center justify-center shadow-inner">
                                    ...
                                    <p class="text-sm font-medium mt-2">Select items from your catalog to begin layout.
                                    </p>
                                </div>
                            </div>
                        </div>
