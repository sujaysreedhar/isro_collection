                    ...
                    <div class="sm:text-center lg:text-left">
                        ...
                        <div class="mt-8 sm:flex sm:justify-center lg:justify-start">
                            <form action="<?= SITE_URL ?>/search.php" method="GET" class="w-full sm:max-w-lg relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="q" data-autocomplete="true" autocomplete="off" class="focus:ring-gray-900 focus:border-gray-900 block w-full pl-10 pr-12 sm:text-lg border-gray-300 rounded-md py-4 shadow-lg" placeholder="Search for items, dates, or stories...">
                    ...
                    <a href="<?= SITE_URL ?>/item/<?= $item['id'] ?>" class="group bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow flex flex-col h-full">
                        <div class="relative h-64 bg-gray-100 flex items-center justify-center overflow-hidden">
                            <?php if (!empty($item['file_path'])): ?>
                                ...
                                <img src="<?= htmlspecialchars($featuredImgUrl) ?>" alt="<?= htmlspecialchars($item['title']) ?>" class="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500" loading="lazy">
                            <?php else: ?>
