<?php
// themes/default/item_detail.php
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="<?= SITE_URL ?>/search.php?category_ids[]=<?= (int)$item['category_id'] ?>" class="hover:text-gray-900"><?= htmlspecialchars($item['category_name']) ?></a>
                        </div>
                    </li>
                    <?php endif; ?>
                    <li>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-12">
                ...
                <div class="xl:col-span-7 border border-gray-200">
                    <div class="bg-white rounded-t shadow-sm overflow-hidden">
                        <div class="relative bg-gray-100 flex items-center justify-center">
                            ...
                            <?php if ($primaryMedia): ?>
                                ...
                                ?>
                                <figure class="w-full">
                                    <img src="<?= $displaySrc ?>" alt="<?= $imageAlt ?>" class="w-full h-auto">
                                    <figcaption class="sr-only"><?= $imageAlt ?></figcaption>
                                </figure>
                            <?php else: ?>
                                <div class="flex items-center justify-center h-[500px] w-full text-gray-400 flex-col">
                    ...
                    <div class="bg-gray-50 flex justify-between items-start text-sm text-gray-500 p-4 rounded-b border-t border-gray-200">
                        <cite class="italic not-italic font-medium text-gray-600"><?= htmlspecialchars($primaryMedia['caption'] ?? 'No description provided.') ?></cite>
