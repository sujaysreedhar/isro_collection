...
<head>
    ...
    <?php if ($ogImage): ?>
        <meta property="og:image" content="<?= htmlspecialchars($ogImage) ?>"><?php endif; ?>
    ...
    <?php if ($ogImage): ?>
        <meta name="twitter:image" content="<?= htmlspecialchars($ogImage) ?>"><?php endif; ?>
...
<body class="text-gray-800 antialiased">
    ...
    <header class="bg-white border-b border-gray-200 sticky top-0 z-50">
        <?php if (class_exists('HookRegistry')) {
            HookRegistry::doAction('frontend_header');
        } ?>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <div class="flex-1 max-w-2xl ml-8 hidden md:block">
                    <form action="<?= SITE_URL ?>/search.php" method="GET" class="relative">
                        ...
                        <input type="text" name="q" data-autocomplete="true" autocomplete="off"
                            ...
                            class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-gray-50 placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-gray-900 focus:border-gray-900 sm:text-sm transition duration-150 ease-in-out"
                            placeholder="Search the collections... (e.g. Steam Engine)">
                    </form>
                </div>
            <?php endif; ?>
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Mobile Menu Button -->
                <button type="button" onclick="toggleMobileMenu()" class="lg:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors focus:outline-none">
        ...
        <div id="mobile-menu" class="hidden lg:hidden bg-white border-b border-gray-200">
            <div class="px-4 py-3">
                <?php if (!$hideHeaderSearch): ?>
                    <form action="<?= SITE_URL ?>/search.php" method="GET" class="relative mb-4">
                        <input type="text" name="q" placeholder="Search..." class="w-full pl-4 pr-3 py-2 border border-gray-300 rounded-md text-sm">
                    </form>
                <?php endif; ?>
