                                    ...
                                    <div class="h-80 relative bg-black">
                                        <?php if ($item['preview_file_path']): ?>
                                            <img src="<?= SITE_URL ?>/uploads/display/<?= rawurlencode($item['preview_file_path']) ?>" 
                                                 class="w-full h-full object-cover transition-transform duration-[1.5s] group-hover:scale-110 opacity-70 group-hover:opacity-100 grayscale-[0.5] group-hover:grayscale-0">
                                        <?php else: ?>
