                ...
                <div class="mb-5 bg-gray-800 p-3 rounded border border-gray-700 text-sm">
                    ...
                    <div class="flex flex-wrap gap-1.5">
                        ...
                        foreach ($activeTags as $aTag): ?>
                            <a href="<?= buildFilterUrl($params, 'tags', $aTag) ?>" class="inline-flex items-center px-2 py-1 rounded bg-purple-600 text-white text-xs hover:bg-red-600 transition">
                                #<?= htmlspecialchars($tagNameMap[$aTag] ?? $aTag) ?> <span class="ml-1 leading-none">&times;</span>
                            </a>
                        <?php endforeach; ?>
                    </div>
                </div>
                        ...
                        <a href="<?= SITE_URL ?>/item/<?= $item['id'] ?>"
                           class="group block border border-gray-700 rounded-lg overflow-hidden hover:border-gray-600 hover:shadow-lg hover:shadow-purple-900/20 transition bg-gray-800 flex flex-col">
                            <div class="h-48 bg-gray-900 flex items-center justify-center p-4">
                                <?php if ($previewUrl): ?>
                                    <img src="<?= htmlspecialchars($previewUrl) ?>" alt="<?= htmlspecialchars($item['title']) ?>" class="object-cover w-full h-full" loading="lazy">
                                <?php else: ?>
