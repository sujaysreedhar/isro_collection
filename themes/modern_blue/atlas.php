        ...
        rawData.forEach(function(loc) {
            if (loc.latitude && loc.longitude) {
                ...
                var statusHtml = isAcquired ? 
                    '<span style="background: #eff6ff; color: #2563eb; padding: 2px 8px; border-radius: 6px; font-weight: 700; font-size: 11px; display: inline-block; margin-top: 4px;">In Collection</span>' : 
